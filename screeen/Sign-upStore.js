...
export default function SignUpScreenStore({ navigation }) {
...
//   const [dob, setDob] = useState('');
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        Alert.alert('Success', 'Registration successful!', [{ text: 'OK', onPress: () => navigation.navigate('Sign-inStore') }]);
      } else {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>You are creating an account as a Store owner</Text>
